                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="invoice_no" id="invoice_no" class="form-control" readonly value="{{ $invoice->invoice_no }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="paid_amount" id="paid_amount" class="form-control" value="{{ $invoice->paid_amount }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <table class="table table-responsive table-striped">
                                        ...
                                        <tfoot>
                                            ...
                                            <th><input class="form-control" type="text" name="total_amount" id="total" placeholder="All Total" readonly value="{{ $invoice->total_amount }}"></th>
                                        </tfoot>
                                    </table>
                                </div>
                            </div>
